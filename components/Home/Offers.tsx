    ...
    return (
        <div className="container">
            <div className="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                {/* Col 1 */}
                <div className="col bg-primary-600 flex justify-between  shadow-xl items-center px-10 group">
                    {/* Inner Col 1 */}
                ...
                <div className="col bg-green-400 flex justify-between  shadow-xl items-center px-10 group">
                    {/* Inner Col 1 */}
                    <div className="space-y-5 basis-1/2">
                        <div>
                            <h3 className="font-bold text-lg text-amber-500">30% off</h3>
                ...
                {/* Col 2 */}
                <div className="col bg-red-300/20 flex justify-between items-center  shadow-xl px-10 group">
                    {/* Inner Col 1 */}
                    <div className="space-y-5 basis-1/2">
                        <div>
